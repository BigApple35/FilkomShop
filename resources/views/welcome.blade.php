                ...
                <div class="bg-gradient-to-r from-[#1f232b] to-[#343a46] rounded-[2rem] shadow-xl overflow-hidden p-6">
                    ...
                    <div class="flex flex-col md:flex-row md:items-center md:justify-between gap-6">
                        ...
                        <div class="grid grid-cols-1 md:grid-cols-3 gap-3 w-full md:w-auto">
                            ...
                            <a href="{{ route('admin.users.show', $user->id) }}" class="bg-white hover:bg-gray-100 text-black text-center py-3 px-6 rounded-full text-lg font-bold transition">
                                Read
                            </a>

                            <a href="{{ route('admin.users.edit', $user->id) }}" class="bg-[#1f232b] hover:bg-[#343a46] border border-gray-500 text-white text-center py-3 px-6 rounded-full text-lg font-bold transition">
                                Edit
                            </a>
                            ...
                            <form action="{{ route('admin.users.destroy', $user->id) }}" method="POST">
                                @csrf
                                @method('DELETE')
                                <button type="submit" onclick="return confirm('Are you sure you want to delete this user?')" class="w-full bg-red-500 hover:bg-red-600 text-white py-3 px-6 rounded-full text-lg font-bold transition">
                                    Delete
                                </button>
                            </form>
