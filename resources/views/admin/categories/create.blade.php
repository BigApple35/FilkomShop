...
<head>
    ...
    <title>Create Category - FILKOMSHOP</title>
...
<body class="bg-[#f3f3f3] min-h-screen m-0">
    ...
    <div class="flex flex-col gap-4 mb-8">
        ...
        <p class="text-gray-500 text-xl">
            Add a new product category classification
        </p>
    </div>
    ...
    <div class="bg-white rounded-[2rem] border border-slate-200 shadow-xl p-8 max-w-2xl w-full">
        <form action="{{ route('admin.categories.store') }}" method="POST" class="space-y-6 m-0">
            @csrf
